...
{
    /// <inheritdoc />
    public partial class Update_SP_Electric_bill : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            WITH PreviousReadingCTE AS (
                SELECT 
                    ...
                    COALESCE(
                        (SELECT TOP 1 eb1.PresentReading 
                         FROM RMS_ELECTRIC_BILL eb1 
                         WHERE eb1.CustomerId = eb.CustomerId 
                         AND eb1.BillNo <> MAX(eb2.BillNo) 
                         ORDER BY eb1.BillNo DESC
                        ), c.ElectricMetterLastReading
                    ) AS PreviousReading
                FROM 
                ...
                GROUP BY 
                    eb.CustomerId, c.CreatedOn, c.ElectricMetterLastReading
            )
