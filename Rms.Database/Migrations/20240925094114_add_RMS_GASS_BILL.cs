...
{
    /// <inheritdoc />
    public partial class add_RMS_GASS_BILL : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RMS_GASS_BILL", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RMS_GASS_BILL_RMS_CUSTOMER_CustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RMS_GASS_BILL_CustomerId",
                table: "RMS_GASS_BILL",
                column: "CustomerId");
        }
